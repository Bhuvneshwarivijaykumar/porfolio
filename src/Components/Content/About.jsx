    ...
    <div id='About' className='bg-white text-black dark:bg-slate-900 dark:text-white lg:px-56 lg:py-0 px-10 py-20 text-center gap-5 lg:text-start flex lg:flex-row flex-col justify-between lg:gap-28 items-center'>
      ...
      <div className='h-full lg:py-40 flex flex-col justify-center lg:items-start items-center'>
        ...
        <p data-aos='fade-left '>
          Hello, I'm Bhuvaneshwari V, a Mernstack devloper. I have a passion for building innovative web applications. I studying at Sri Eshwar College of Engineering with a specialization in Electronics and communication Engineering. Proficient in web development, I have good leadership and communication skills. 
